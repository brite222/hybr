  ...
  return (
    <div className="module-page">
      ...
      <main className="module-main">
        ...
        {loading ? (
          <div style={{ padding: 80, textAlign: "center", color: "#666" }}>Loading your dashboard...</div>
        ) : error ? (
          ...
          <>
            ...
            <div className="student-hero">
              <div className="student-hero-content">
                <h1 className="student-hero-title">Welcome back, {user?.firstName || "FirstName"}! 👋</h1>
                <p className="student-hero-text">Keep learning. Keep growing. Lorem ipsum dolor sit amet.</p>
              </div>
            ...
            {!hasStarted && (
              <div className="kickoff-banner">
                ...
                <div className="kickoff-content">
                  ...
                  <div className="kickoff-date">ONBOARDING: {formatKickoffDate()}</div>
                </div>
                <span className="kickoff-emoji">🚀</span>
              </div>
            )}
            ...
            <div className="dash-section-card">
              <div className="dash-section-header">
                ...
                <button className="dash-section-link-top" onClick={() => navigate("/courses/overview")}>
                  View All
                </button>
              </div>
            ...
            <div className="dash-section-card">
              <div className="dash-section-header">
                ...
                <button className="dash-section-link-top" onClick={() => navigate("/achievements")}>
                  View all →
                </button>
              </div>
              <p className="dash-section-sub">Badges you've earned along your journey.</p>
                ...
                <div className="achievements-grid">
                  {achievements.map((a, idx) => (
                    <div key={a.id || idx} className="achievement-item">
                      ...
                      <div className="achievement-desc">{a.description || "Lorem ipsum dolor sit amet."}</div>
                    </div>
                  ))}
                </div>
              )}

              <button className="dash-section-link-bottom" onClick={() => navigate("/achievements")}>
                <EyeIcon /> VIEW ALL
              </button>
            </div>
          </>
